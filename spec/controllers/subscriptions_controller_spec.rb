  ...
  describe 'DELETE #destroy' do
    ...
    context 'Author tries' do
      ...
      it 'deletes his subscription' do
        expect { delete :destroy, params: { id: question.id }, format: :js }.to change(question.subscriptions, :count).by(-1)
      end
    ...
    context 'Not author tries' do
      ...
      it 'delete not his subscription' do
        expect { delete :destroy, params: { id: question.id }, format: :js }.to_not change(question.subscriptions, :count)
      end
    end
  end
end